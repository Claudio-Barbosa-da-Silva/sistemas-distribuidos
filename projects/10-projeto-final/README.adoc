...
Uma lista de cidades e estados com os códigos do IBGE pode ser obtida https://www.ricardoarrigoni.com.br/cidades-brasil-lista-de-cidades-brasileiras-em-sql/[aqui].
